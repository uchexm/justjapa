            ...
            <div className='container-consistent'>
                <div className='flex flex-col items-center justify-center gap-6 sm:gap-8'>
                    ...
                    <div className='w-full max-w-4xl'>
                        ...
                        <nav className='flex flex-wrap items-center justify-center gap-x-4 gap-y-2 text-center sm:hidden'>
                            <Link
                                href='/'
                                className='link-hover-simple px-2 text-sm font-normal text-black'
                            >
                                Home
                            </Link>
                        ...
                        <nav className='hidden flex-wrap items-center justify-center text-center text-base font-normal text-black sm:flex lg:text-lg xl:text-2xl'>
                            <Link href='/' className='link-hover-simple px-2'>
                                Home
                            </Link>
                            <span className='mx-2 text-gray-400 lg:mx-4'>|</span>
                            <Link href='/coming-soon' className='link-hover-simple px-2'>
                                How It Works
                            </Link>
                            <span className='mx-2 text-gray-400 lg:mx-4'>|</span>
                            <Link href='/coming-soon' className='link-hover-simple px-2'>
                    ...
                    <div className='flex items-center justify-center gap-4 sm:gap-6'>
                        ...
                        <a href='#' className='icon-hover-simple' aria-label='LinkedIn'>
                            ...
                            >
                                <path
                                    d='M6.83301 37.583H0V14.5205H6.83301V37.583ZM18.791 14.5205V15.958C19.8603 15.5803 21.0103 15.375 22.208 15.375C27.8693 15.375 32.458 19.9641 32.458 25.625V37.583H25.625V25.625C25.625 23.738 24.095 22.208 22.208 22.208C20.321 22.208 18.791 23.738 18.791 25.625V37.583H11.958V14.5205H18.791ZM3.41634 3.41699C5.30331 3.41699 6.83301 4.94618 6.83301 6.83301C6.83301 8.71998 5.30331 10.25 3.41634 10.25C1.52948 10.2498 0 8.71987 0 6.83301C0 4.94629 1.52959 3.41717 3.41634 3.41699Z'
                                    fill='#0178FF'
                                />
                            </svg>
                        </a>
                    ...
                    <div className='text-center'>
                        <p className='text-xs text-black opacity-75 sm:text-sm'>
